...
import DataTableComponent from '../../Admin/DataTable/DataTable'
...
export default function EndUserTable() {
    ...
    const EndUserActionButtons = (rowData: EndUser) => (
        <div className="mr-4 flex justify-start gap-4">
            {isSuperAdmin && (
                <>
    ...
    return (
        <DataTableComponent
            ...
            size={size}
            setSize={setSize}
            EndUserActionButtons={EndUserActionButtons}
            toastRef={toast}
        />
    )
}
