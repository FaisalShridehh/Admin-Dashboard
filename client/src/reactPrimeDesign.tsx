...
export const Tailwind = {
    datatable: {
        ...
        loadingicon: 'w-8 h-8',
        wrapper: ({ props }) => ({
            className: classNames(' h-[calc(100vh-212px)] overflow-auto', {
        ...
        table: 'w-full border-spacing-0 h-full  ',
        thead: ({ context }) => ({
            className: classNames({
        ...
        column: {
            ...
            bodycell: ({ props, context }) => ({
                className: classNames(
                    ...
                    {
                        'sticky bg-inherit':
                            props && (props.frozen || props.frozen === ''), // Frozen Columns
                        'border-x border-y': context.showGridlines,
                    }
                ),
            }),
    ...
    paginator: {
        root: {
            className: classNames(
                ...
                'bg-white text-gray-500 border-0 px-4   rounded-md',
        ...
        rowperpagedropdown: {
            ...
            trigger: {
                className: classNames(
                    'flex items-center justify-center shrink-0 text-red-500',
            ...
            wrapper: 'overflow-auto border-2 border-red-200',
            list: 'm-0 p-0 py-3 list-none border-2 border-red-200',
            // RPPDropdown:'border-2 border-red-200',
            item: ({ context }) => ({
                className: classNames(
